...
const managementFaqs = [
  ...
  {
    question: "In a 1:1, a senior engineer, recently appointed as Tech Lead for the first time, shares with you that they're confident in their technical skills but struggle with guiding the team. They ask for leadership advice. What's your approach in such a scenario?",
    answer: "I would approach this by first acknowledging their feelings and providing perspective. It's important they feel supported and understand that learning to guide a team takes time, and it's okay to not feel confident initially. Just like any other role, it's a learning process. I believe everyone has a different leadership style, and it takes time to find what feels comfortable and works for them. What works for me won't always work for them, but I'm there to help support and guide. I'd then give practical steps: encourage them to establish clear communication and expectations with the team, perhaps re-align if stepping into an existing team. Focus on outcomes rather than micromanaging. Get to know team members and build trust through openness, asking questions, active listening, and ensuring regular 1:1s happen. Finally, I'd offer ongoing support as a sounding board with regular check-ins, provide timely feedback when I observe anything, and point them toward internal resources like new lead training or relevant books and online resources.",
  },
]
