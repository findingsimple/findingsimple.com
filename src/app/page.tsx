...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://docs.google.com/document/d/11hqUdT45kOTPYf8sF0gaRq6X3iKCzkB5CH4tyA7EK04/edit?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            software, 3D prints, or reef tanks, I’m happiest when I’m building and colaborating with great people.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.instagram.com/finding.simple"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/findingsimple"
