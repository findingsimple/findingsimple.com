      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/user-manual">User Manual</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
...
function DesktopNavigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-xs font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 whitespace-nowrap">
        <NavItem href="/about">About</NavItem>
        <NavItem href="/projects">Projects</NavItem>
        <NavItem href="/faqs">FAQs</NavItem>
        <NavItem href="/user-manual">User Manual</NavItem>
      </ul>
    </nav>
  )
}
